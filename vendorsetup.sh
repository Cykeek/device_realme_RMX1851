...
git clone https://github.com/Cykeek-Labs/kernel_realme_sdm710 -b rui2 kernel/realme/sdm710

# RealmeParts
banner 2>1
echo "Cloning RealmeParts..."
git clone https://github.com/Cykeek-Labs/packages_apps_realmeparts -b A11 packages/apps/RealmeParts
